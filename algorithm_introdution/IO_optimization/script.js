...
code_data = {
    s1: "#include&ltbits/stdc++.h&gt \nusing namespace std; \n \n#define endl '\\n' // or don't use endl use '\\n' instead \n \nint main() { \n    cin.tie(0), ios_base::sync_with_stdio(0); \n \n    // your solution  \n}",
    s2: "#include&ltbits/stdc++.h&gt \nusing namespace std; \n \nint main() { \n    cin.tie(0), ios_base::sync_with_stdio(0); \n \n    // your solution  \n    cout &lt&lt ans &lt&lt endl; \n}",
}

function setup() {
    print_code(code_data.s1, hls_data.cpp_hls, "//", "\"", "crt");
    print_code(code_data.s2, hls_data.cpp_hls, "//", "\"", "err");
}
